        ...
        {tab === 'overview' ? (
          <>
            ...
            <AppCard style={styles.menuCard}>
              ...
              <View style={[styles.menuDivider, { backgroundColor: Colors[colorScheme ?? 'light'].border }]} />
              <Pressable onPress={() => router.push('/business')} style={styles.menuRow}>
                <View style={[styles.menuIcon, { backgroundColor: 'rgba(240, 138, 26, 0.14)' }]}>
                  <IconSymbol name="chart.bar.fill" size={18} color="#E98100" />
                </View>
                <ThemedText type="defaultSemiBold" style={styles.menuLabel}>Business Dashboard</ThemedText>
                <View style={{ flex: 1 }} />
                <IconSymbol name="chevron.right" size={18} color={Colors[colorScheme ?? 'light'].icon} />
              </Pressable>
              <View style={[styles.menuDivider, { backgroundColor: Colors[colorScheme ?? 'light'].border }]} />
              <Pressable onPress={() => router.push('/favorites/exchanges')} style={styles.menuRow}>
                ...
                <ThemedText type="defaultSemiBold" style={styles.menuLabel}>Favorite Exchanges</ThemedText>
                <View style={{ flex: 1 }} />
                <IconSymbol name="chevron.right" size={18} color={Colors[colorScheme ?? 'light'].icon} />
              </Pressable>
              <View style={[styles.menuDivider, { backgroundColor: Colors[colorScheme ?? 'light'].border }]} />
              <Pressable onPress={() => router.push('/alerts/exchanges')} style={styles.menuRow}>
                <View style={[styles.menuIcon, { backgroundColor: 'rgba(77, 163, 255, 0.14)' }]}>
                  <IconSymbol name="bell.fill" size={18} color={Colors[colorScheme ?? 'light'].tint} />
                </View>
                <ThemedText type="defaultSemiBold" style={styles.menuLabel}>Rate Alerts</ThemedText>
                <View style={{ flex: 1 }} />
                <IconSymbol name="chevron.right" size={18} color={Colors[colorScheme ?? 'light'].icon} />
              </Pressable>
              <View style={[styles.menuDivider, { backgroundColor: Colors[colorScheme ?? 'light'].border }]} />
